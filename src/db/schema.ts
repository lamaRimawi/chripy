...
export const users = pgTable("users", {
  ...
  isChirpyRed: boolean("is_chirpy_red").notNull().default(false), // العمود الجديد
  
});

// تعريف نوع المستخدم الذي يتم إرجاعه للعميل (بدون كلمة المرور)
...
// تحديث نوع الرد ليشمل الحقل الجدي
